<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../appDesing/css/bodycontents/lobby.css">
    ...
    <body>
        ...
        <div class="main">
            ...
            <section id="" class=" containerbox col-md-12 container">
                ...
                <i class=" slideLeft  fas fa-calculator  col-md-3 it "></i>
                <i class=" slideRight  fas fa-shopping-cart  col-md-3 it "></i>
                <i class=" slideUp fas fa-sliders-h  col-md-3 it "></i>
            </section>
            <footer id="footer">
