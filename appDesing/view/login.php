...
<html>
    <head>
        ...
        <link rel="stylesheet" href="lib/loadjs/loadjs.css">
    ...
    <body>
        ...
        <div id="div_carga">
            <img id="cargador" src="appDesing/img/gifcarga.gif"/>
        </div>
                ...
                <center>
                    <div class="middle">
                        ...
                        <div id="logobox" class="logo">
                            <img class="slideExpandUp  sobralogo  " src="appDesing/img/logo.png" width="170" height="170"/>
                            <div class="clearfix"></div>
                        </div>
